...
public class QuestionController extends BaseController {
	...
	public Question save(@RequestBody Question question){
		...
		String cateid = question.getCate().getId();
		String catename = question.getCate().getName();
		...
		return questionService.save(param, question.getCreateUser());
	}
	/**
	 * 问题删除
	...
	public JSONObject loadList(String cateId, Integer page, Integer limit, String keyword, Integer type){
...
//		}
	...
	public QuestionCate saveCate(String id, String pid, String name, String username){
		QuestionCate cate = null;
		if (StringUtils.isBlank(id)){
			cate = new QuestionCate();
			cate.setCreateUser(username);
			cate.setModifyUser(username);
		}else{
